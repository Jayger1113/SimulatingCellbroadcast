...
public class Channel4370Constants {

    public static final String TEST_CHANNEL_MESSAGE = "This is channel testing message";

    public static final int TEST_CHANNEL_4370 = 4370;
    ...
    public static final int TEST_SERIAL_NUM = 241;
    ...
    public static final int TEST_CMASINFO_MESSAGE_CLASS = 0;
